...
my @paths = (
    ...
    'dashboards/plugin',
    'dashboards/even-hub',
    'dashboards/ajax/bootstrap',
    'dashboards/ajax/health',
    'dashboards/ajax/prompt',
    'dashboards/ajax/session',
    'dashboards/public/css/dd-plugin.css',
    'dashboards/public/css/even-hub-app.css',
    'dashboards/public/js/dd-plugin.js',
    'dashboards/public/js/even-hub-app.js',
    'dashboards/public/others/dd-plugin-manifest.json',
    'even-hub/index.html',
